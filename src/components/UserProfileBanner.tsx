    ...
    >
      <div className="bg-white text-black rounded-2xl overflow-hidden border-2 border-primary/35 shadow-[0_14px_34px_rgba(0,0,0,0.22)]">
        ...
        <div className="flex md:hidden">
          ...
          <Link to="/fotografias-3buk" className="w-1/3 shrink-0 border-l-2 border-primary/30 flex flex-col items-center justify-center gap-2 p-3 bg-[#E6F7EE] hover:bg-[#d4f0df] transition-colors cursor-pointer">
        ...
        <div className="hidden md:flex">
          ...
          <Link to="/fotografias-3buk" className="w-1/3 shrink-0 border-l-2 border-primary/30 flex flex-col items-center justify-center gap-3 p-6 bg-[#E6F7EE] hover:bg-[#d4f0df] transition-colors cursor-pointer">
